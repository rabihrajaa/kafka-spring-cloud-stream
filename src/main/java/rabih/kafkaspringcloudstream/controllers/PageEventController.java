package rabih.kafkaspringcloudstream.controllers;
...
public class PageEventController {
    // Inject StreamBridge to send messages to topics
    @Autowired
    ...
    // Endpoint to provide real-time analytics as a stream of server-sent events
